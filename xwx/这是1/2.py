...
button_text_list = ['算了吧', '我会修复读机', '我妈会游泳', '我会修电脑', '我会写代码', '我最喜欢你']
...
def main():
    ...
    pygame.display.set_caption('FROM 喜欢你很久的kyx')
        ...
        if mouse_pos[0] < unlike_pos_x+unlike_pos_width and mouse_pos[0] > unlike_pos_x and\
            ...
            while True:
                ...
                if mouse_pos[0] < unlike_pos_x+unlike_pos_width and mouse_pos[0] > unlike_pos_x and\
                    ...
                    continue
                break
        title('项薇旭小姐姐，我观察你很久了', screen, scale=[1.8, 10])
        title('做我女朋友好不好呀', screen, scale=[1.8, 3])
        button('好的鸭', like_pos_x, like_pos_y, like_pos_width,
